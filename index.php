       ...
       <div class="row  anim-300">
         <div class="col-xl-9 col-lg-9 col-12 d-flex flex-wrap blog-post-parent">
           <?php if (have_posts()): while (have_posts()) : the_post(); ?>
             <div class="col-12 blog-post apparition-3 d-flex mb-30">
         ...
         <aside class="col-xl-3 col-lg-3 col-12 d-flex flex-column flex-wrap">
              ...
              <?php if ( $the_query->have_posts() ) : ?>
                <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
                  ...
                  <a class="" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                    <div class="d-flex align-items-center mb-30 apparition-3">
